...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the var declaration from `var to `let`.
  // The previous code threw an error because let introduces blocked scope which makes rando only accessible within that while loop.
  console.log(viewed)
