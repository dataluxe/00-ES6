...
function displayPics(){
  ...
  // DONE: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to `const`.
  // The 'rando' in the console.log() above cannot connect to the 'rando' in displayPics() because 'const' only scopes the variable to its block of curly braces... in this case, the 'while' loop above, making it scope-inaccessible to the console.log().
  console.log(viewed)
