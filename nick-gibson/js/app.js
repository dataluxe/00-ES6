...
function displayPics(){
  ...
  // using 'const' on line 32 sets its scope to within the while loop from line 31. The console.log on line 37 is outside of this code block, so 'rando' is undefined in this scope.
  console.log(viewed)
