...
function displayPics(){
  ...
  // The above rando variable is declared with let in the FIRST while loop so it is scoped for that block, and this console.log is outside of that block so rando isn't recognized. var rando is global, let rando is inside the while-block.
